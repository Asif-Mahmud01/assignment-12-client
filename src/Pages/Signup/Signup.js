...
const Signup = () => {
    ...
    const handleSignin = data => {
        ...
        const saveUser = (name, email) => {
            ...
            fetch('https://book-mart-server-1.vercel.app/users', {
                method: 'POST',
                headers: {
                ...
                <div>
                    <form onSubmit={handleSubmit(handleSignin)} >
                        ...
                        <div className="form-control w-full max-w-xs">
                            ...
                            {/* {...register('condition')} */}
                                <option required disabled selected>Options</option>
                                <option>Admin</option>
                        ...
                        <p>New to book mart? <Link className='text-primary' to='/login'>Already have new account?</Link></p>
