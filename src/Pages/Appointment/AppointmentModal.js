...
const AppointmentModal = ({ treatment, selectedDate, setTreatment }) => {
    const { name: treatmentName, name, price } = treatment
    ...
    const handleBooking = event => {
        ...
        fetch('https://book-mart-server-1.vercel.app/bookings', {
            method: 'POST',
            headers: {
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking}>
                        ...
                        } disabled placeholder="" className="input input-bordered my-2 input-primary w-full " />

                        <input type="text" name='price' defaultValue={price
                        } disabled placeholder="" className="input input-bordered my-2 input-primary w-full " />

                        <input type="password" name='password' defaultValue={user?.email} disabled placeholder="input password" className="input input-bordered my-2 input-primary w-full " />
